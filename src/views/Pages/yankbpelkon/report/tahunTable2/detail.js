...
class Detail extends Component {	
    constructor(props) {
        ...
        this.state = {
            ...
            tableHead: [],
            datas: [
                { id: 1, kode: 11,provinsi: 'ACEH',dt1:23,dt2:58,dt3:49,dt4:32,dt5:98,dt6:12,dt7:39,dt8:88,dt9:37,dt10:29,dt11:44,dt12:213,dt13:23},
                { id: 2, kode: 12,provinsi:'SUMATERA UTARA',dt1:23,dt2:58,dt3:49,dt4:32,dt5:98,dt6:12,dt7:39,dt8:88,dt9:37,dt10:29,dt11:44,dt12:213,dt13:23}
            ],
        };
    ...
    return (<div><Link to={`/lap/DetailYankb/tahun/table2/provinsi?provinsi=${row.provinsi}`}>{row.provinsi}</Link></div>);
    }
    ...
    exportPDF = () => {
        ...
        const title = "Tempat Pelayanan KB Pemerintahan";
                    ...
                    <Col xs="12" md="12">
                        <Card>
                            <CardBody>
                                <Row>
                                    <Col md="12">
                                        <div className="titleFilter"><i className="icon-filter4"></i> Laporan YANKB Tempat Pelayanan KB Pemerintah</div>
                                    </Col>
