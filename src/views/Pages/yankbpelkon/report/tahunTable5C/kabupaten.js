...
class Kabupaten extends Component {	
    ...
    render() {
        ...
        return (
            ...
            datas =  {
                [
                    { id: 1, kode: 11,provinsi: 'KLUET UTARA',dt1:23,dt2:58,dt3:49,dt4:32,dt5:98,dt6:12,dt7:39,dt8:88,dt9:37,dt10:29,dt11:44,dt12:213,dt13:40,dt14:20,dt15:39,dt16:16},
                    { id: 2, kode: 12,provinsi: 'BAKONGAN',dt1:23,dt2:58,dt3:49,dt4:32,dt5:98,dt6:12,dt7:39,dt8:88,dt9:37,dt10:29,dt11:44,dt12:213,dt13:40,dt14:20,dt15:39,dt16:16}
                ]
            }
            title = {"YANKB Laporan Tempat Pelayanan KB Swasta Berdasarkan Status Kerjasama Dengan BPJS Kesehatan"}
            namaLaporan = {`YANKB Laporan Tempat Pelayanan KB Swasta Berdasarkan Status Kerjasama Dengan BPJS Kesehatan di ${params.kabupaten}`}
            marginLeft = {200}
            header = {
                [
                    [
