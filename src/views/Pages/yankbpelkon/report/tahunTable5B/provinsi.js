...
class Provinsi extends Component {	
    ...
    return (<div><Link to={`/lap/DetailYankb/tahun/table5B/kabupaten?kabupaten=${row.provinsi}`}>{row.provinsi}</Link></div>);
    }
                    ...
                    <Col xs="12" md="12">
                        <Card>
                            <CardBody>
                                <Row>
                                    <Col md="12">
                                        <div className="titleFilter"><i className="icon-filter4"></i> YANKB Laporan Tempat Pelayanan KB Pemerintah Berdasarkan Status Kerjasama Dengan BPJS Kesehatan di {params.provinsi}</div>
                                    </Col>
