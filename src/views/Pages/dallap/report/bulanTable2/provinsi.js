...
class Provinsi extends Component {	
    ...
    return (<div><Link to={`/lap/DetailDallap/table2/kabupaten?kabupaten=${row.provinsi}`}>{row.provinsi}</Link></div>);
    }
                    ...
                    <Col xs="12" md="12">
                        <Card>
                            <CardBody>
                                <Row>
                                    <Col md="12">
                                        <div className="titleFilter"><i className="icon-filter4"></i> Laporan YANKB Frekuensi Operasioanl Mupen Provinsi</div>
                                    </Col>
