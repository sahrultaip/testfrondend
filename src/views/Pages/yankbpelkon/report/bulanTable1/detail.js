...
class Detail extends Component {	
    ...
    return (<div><Link to={`/lap/DetailYankb/table1/provinsi?provinsi=${row.provinsi}`}>{row.provinsi}</Link></div>);
    }
    ...
    setHead() {
        ...
        { width:"100",title: "Kabupaten / Kota", row: '1',colSpan:'3', headerAlign: POSITION.CENTER, dataAlign: POSITION.CENTER },
