...
class Provinsi extends Component {	
    constructor(props) {
        ...
        this.state = {
            ...
            datas: [
                ...
                { id: 2, kode: 12,provinsi:'ACEH UTARA',dt1:23,dt2:58,dt3:49,dt4:32,dt5:98,dt6:12,dt7:39,dt8:88,dt9:37,dt10:29,dt11:44,dt12:213,dt13:76}
            ],
        };
    ...
    return (<div><Link to={`/lap/DetailDallap/table3/kabupaten?kabupaten=${row.provinsi}`}>{row.provinsi}</Link></div>);
    }
    ...
    exportPDF = () => {
        ...
        const title = "Frekuensi Oprasional Mupen Kabupaten/Kota";

        const headers = [
            [
                { content: 'Kode', rowSpan: 2, styles: { halign: 'center' } },
                { content: 'Kabupaten', rowSpan: 2, styles: { halign: 'center' } },
                { content: 'Mupen Kab/Kota', colSpan: 3, styles: { halign: 'center' } },
                { content: 'Operasional Mupen Kab/Kota', colSpan: 3, styles: { halign: 'center' } },
                { content: 'Frekuensi Operasional Mupen Kab/Kota Berdasarkan Jenis Kegiatan', colSpan: 2, styles: { halign: 'center' } },
                { content: 'Frekuensi Operasional Mupen Kab/Kota Berdasarkan Sumber Dana Kegiatan', colSpan: 3, styles: { halign: 'center' } },
    ...
    setHead() {
        ...
        { width:"100",title: "Operasional Mupen Kab/Kota", row: '0',colSpan:'3', headerAlign: POSITION.CENTER, dataAlign: POSITION.RIGHT },
        ...
        { width:"100",title: "Frekuensi Operasional Mupen Kab/Kota Berdasarkan Jenis Kegiatan", row: '0',colSpan:'2', headerAlign: POSITION.CENTER, dataAlign: POSITION.RIGHT },
        ...
        { width:"100",title: "Frekuensi Operasional Mupen Kab/Kota Berdasarkan Sumber Dana Kegiatan", row: '0',colSpan:'3', headerAlign: POSITION.CENTER, dataAlign: POSITION.RIGHT },
                    ...
                    <Col xs="12" md="12">
                        <Card>
                            <CardBody>
                                <Row>
                                    <Col md="12">
                                        <div className="titleFilter"><i className="icon-filter4"></i> Frekuensi Operasional Mupen Kab/Kota</div>
                                    </Col>
