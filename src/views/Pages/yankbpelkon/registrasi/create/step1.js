                            ...
                            <CardBody className="card-body-nopad mt-3">
                                <FormGroup>
                                    <Row>
                                        ...
                                        <Col lg="4">
                                            <Input type="text" id="text-input" name="text-input" className="text-center" value={this.props.no_jaringan} disabled />
                                        ...
                                        <Col lg="4">
                                            ...
                                            <div style={{ float: 'left', width: '48%' }}>
                                                <Input type="text" id="tahun" name="tahun" className="text-center" value={tahun} disabled />
                                            </div>
