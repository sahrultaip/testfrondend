...
class Kabupaten extends Component {	
    constructor(props) {
        ...
        this.state = {
            ...
            tableHead: [],
            datas: [
                { id: 1, kode: 11,provinsi: 'KLUET UTARA',dt1:23,dt2:58,dt3:49,dt4:32,dt5:98,dt6:12,dt7:39,dt8:88,dt9:37,dt10:29,dt11:44,dt12:213,dt13:40},
                { id: 2, kode: 12,provinsi:'BAKONGAN',dt1:23,dt2:58,dt3:49,dt4:32,dt5:98,dt6:12,dt7:39,dt8:88,dt9:37,dt10:29,dt11:44,dt12:213,dt13:40}
            ],
        };
    ...
    exportPDF = () => {
        ...
        const headers = [
            [
                ...
                { content: 'Kecamatan', rowSpan: 4, styles: { halign: 'center' } },
    ...
    setHead() {
        ...
        { width:"150",dataFormat: this.CellFormatter,dataField:'provinsi',title: "Kecamatan", row: '0', rowSpan: '4', headerAlign: POSITION.CENTER, dataAlign: POSITION.LEFT },
                    ...
                    <Col xs="12" md="12">
                        <Card>
                            <CardBody>
                                <Row>
                                    <Col md="12">
                                        <div className="titleFilter"><i className="icon-filter4"></i> Laporan YANKB Tempat pelayanan KB Pemerintah Berdasarkan Kepemilikan di {params.kabupaten}</div>
                                    </Col>
