...
class MutasiAlokon extends Component {
    constructor(props) {
        ...
        // this.setBody2 = this.setBody2.bind(this);
    ...
    //     API012.get('siga/reg-mut-alo/datRegisterAlokon/')
    //         .then(res => {
    //             //   if(res.status === 200){ 
    //             console.log(res);
    ...
    handleClickAction = (row, action) => {
        ...
        sessionStorage.setItem('kd_prov', this.state.depdagriProv);
        sessionStorage.setItem('kd_kab', this.state.depdagriKab);
    ...
    handleCreate = () => {
        ...
        sessionStorage.setItem('no_jaringan', this.state.detailDatas2[4]);
